...
const AddRoom = () => {
  ...
  return (
    <div>
     <form>
     <Title align='left' font='outfit' title='Add Room' subTitle='Add a new room to your hotel.Fill in the details carefully and let our 
     team handle the rest.Hope you have a great stay!'/>
     ...
     <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
         ...
         onChange={(e) => setInputs({...inputs, roomType: e.target.value})} className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
