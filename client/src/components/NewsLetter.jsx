...
const NewsLetter = () => {
  return (
        ...
        mx-2 lg:mx-auto my-30 bg-gray-900 text-white mt-10 mb-10">
             
              <Title  title='Stay Inspired' subTitle="Sign up for our newsletter to receive the latest updates and exclusive offers"/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                    <img className ='w-3.5 invert group-hover:translate-x-1 transition-all' src={assets.arrowIcon} alt="" />
                </button>
            </div>
